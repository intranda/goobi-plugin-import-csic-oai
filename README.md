# Goobi workflow Plugin: goobi-plugin-import-csic-oai
...
This legacy Import plugin for Goobi workflow allows the import of proprietary data via OAI-PMH for the Consejo Superior de Investigaciones Cientificas (CSIC).
